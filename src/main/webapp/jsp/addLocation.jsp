...
<html>
    ...
    <body>
        <div class="container">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="location" action="addLocation" method="POST">
                <div class="form-group">
                    <label for="add-locationName" class="col-md-5 control-label">Location Name:</label>
                    <div class="col-md-4">
                        <sf:input type="text" class="form-control" name="locationName" path="locationName" placeholder="Enter location name" required="true"/>
                        <sf:errors path="locationName" cssClass="error"></sf:errors>
                    </div>
                </div>
                <div class="form-group">
                    <label for="add-description" class="col-md-5 control-label">Location description:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-street" class="col-md-5 control-label">House number and street:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-state" class="col-md-5 control-label">2-character state/province (if applicable):</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-zip" class="col-md-5 control-label">Postal code:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-country" class="col-md-5 control-label">2-character Country code:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-latitude" class="col-md-5 control-label">Latitude:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="add-longitude" class="col-md-5 control-label">Longitude:</label>
                    <div class="col-md-6">
