        ...
        <div class="container">
            ...
            <sf:form class="form-horizontal" role="form" modelAttribute="sighting" action="addSighting" method="POST">
                <div class="form-group">
                    <label for="add-date" class="col-md-5 control-label">Date of Sighting:</label>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label for="add-superhumans" class="col-md-5 control-label">Known superheroes spotted (select all that apply):</label>
                    <div class="col-md-6">
